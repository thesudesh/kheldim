...
<section class="update-product">
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <span>update product category:</span>
      <input type="text" class="box" maxlength="100" placeholder="enter the product category" name="category" value="<?= $fetch_products['category']; ?>">
